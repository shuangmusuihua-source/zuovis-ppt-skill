...
| 文字 | `#0F172A` | `#F1F5F9` |
| 次要文字 | `#1E293B` | `#94A3B8` |
| 玻璃卡底 | `rgba(255,255,255,0.6)` | `rgba(30,41,59,0.7)` |
...
| architecture | HTML 组件拼装，支持层级/中心平台/能力矩阵三种样式，自由组装 | ≤6层 |
...
更多细节和每种 content_type 的 HTML 模板见 `references/html-templates.md`。架构图组件见 `references/arch-components.md`。
